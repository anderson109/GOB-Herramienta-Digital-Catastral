...
/**
 * @extends ModelResource<CondicionesAmbientales>
 */
class CondicionesAmbientalesResource extends ModelResource
{
    protected string $model = CondicionesAmbientales::class;

    protected string $title = 'Condiciones Ambientales';
    ...
    public function fields(): array
    {
        return [
            Block::make([
                ...
                Text::make('Condiciones Ambientales','RiesgosNaturales')->required()->showOnExport()->useOnImport(),
    ...
    public function filters(): array
    {
        return [
            ...
            Text::make('Condiciones Ambientales','RiesgosNaturales'),
    ...
    /**
     * @param CondicionesAmbientales $item
     *
